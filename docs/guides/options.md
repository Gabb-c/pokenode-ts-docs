...
export interface ClientArgs {
  ...
  baseUrl?: string; // Location of the PokéAPI. Leave empty to use the official PokéAPI instance.
}
```
...
- [Axios-cache-adapter](https://github.com/RasCarlito/axios-cache-adapter#options)
